...
class learn_hexadecimal_to_binary extends StatefulWidget {
  @override
  _learn_hexadecimal_to_binaryState createState() => _learn_hexadecimal_to_binaryState();
}

// ignore: camel_case_types
class _learn_hexadecimal_to_binaryState extends State<learn_hexadecimal_to_binary> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "To convert number from hexadecimal number system to the binary number system, we first have to convert the hexadecimal number into the decimal form. Then convert  this decimal number into the binary form.",
                style: TextStyle(fontSize: ScreenUtil().setSp(20)),
              ),
              SizedBox(
                height: ScreenUtil().setHeight(10),
