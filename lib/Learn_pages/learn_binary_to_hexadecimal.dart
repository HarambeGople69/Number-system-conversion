...
class learn_binary_to_hexadecimal extends StatefulWidget {
  @override
  _learn_binary_to_hexadecimalState createState() =>
      _learn_binary_to_hexadecimalState();
}

// ignore: camel_case_types
class _learn_binary_to_hexadecimalState
    extends State<learn_binary_to_hexadecimal> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "To convert number from binary number system to the hexadecimal number system, we first have to convert the binary number into the decimal form. Then convert  this decimal number into the hexadecimal form.",
                style: TextStyle(fontSize: ScreenUtil().setSp(20)),
              ),
              SizedBox(
                height: ScreenUtil().setHeight(10),
                  ...
                  setState(() {
                    ...
                    Textbody =
                        learn_number_conversion_of_binary_to_decimal(InputValue)
                            .toString();
                    TextbodyFinal =
                        learn_number_conversion_of_decimal_to_hexadecimal(
                            decimal);
