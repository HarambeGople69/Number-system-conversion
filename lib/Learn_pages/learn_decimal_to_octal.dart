...
class learn_decimal_to_octal extends StatefulWidget {
  @override
  _learn_decimal_to_octalState createState() => _learn_decimal_to_octalState();
}

// ignore: camel_case_types
class _learn_decimal_to_octalState extends State<learn_decimal_to_octal> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                "To convert decimal number integer part into octal, divide the number by 8 and record the remainder. Then divide the result of this division again by 8 and so on until the result of the division is zero.\nTo get the octal of the fractional part, we  have to multipy fractional part by 8 and take the integer part before the decimal point as result. Then the remaining fraction part will be again multiplied by 8.",
                style: TextStyle(fontSize: ScreenUtil().setSp(20)),
              ),
              SizedBox(
                height: ScreenUtil().setHeight(10),
              ...
              TextField(
                onSubmitted: (String value) {
                  setState(() {
                    ...
                    Textbody = learn_number_conversion_of_decimal_to_octal(
                        InputValue).toString();
                    print(Textbody);
                  });
                },
                      ...
                      children: [
                        ...
                        RichText(text: TextSpan(
                          children: <TextSpan>[
                            TextSpan(
                          children: <TextSpan>[
                              TextSpan(text: "Convert ($InputValue)\u2081\u2080 to octal system\n\n",
