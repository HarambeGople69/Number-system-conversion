...
String learn_number_conversion_of_decimal_to_octal(String decimalString) {
  ...
  String finatText =
      "For the conversion of ($decimalString)${unicode_map[10][1]} to octal number system, we divide the integer part by 8 and record the remainder. Then divide the result of this division again by 8 and so on until the result of division is zero\n\n";
  ...
  if (decimalString.contains(".")) {
    ...
    do {
      rInt = decimal ~/ 8;
      r = (decimal % 8).toString();
      text = text + r;
      explain = explain + "$decimal ÷ 8 = ${decimal ~/ 8} Remainder $r \n";
      decimal = rInt;
    } while (rInt != 0);
    ...
    finatText = finatText +
        ...
        "\n\nThe complete result is: \n\n($dublicateFirst)${unicode_map[10][1]} = ($text)${unicode_map[8][1]}\n\nTo get the octal of the fractional part ($decimal_last_part), we have multiplied this part by 8 and take the integer part before the decimal point as result. Then the remaining fractional part will be again multiplied by 8.\n\n";

    last_part_list = fractional_part(decimal_last_part);
    last_part_first = last_part_list[0];
    last_part_last = last_part_list[1];
    finatText = finatText +
        "$last_part_first \nNow, we have to scan the integer from the top. So, the fractional part octal number is = $last_part_last\n";
    finatText +=
        // ignore: unnecessary_brace_in_string_interps
        "\nThe complete result is:\n\n($dublicate)${unicode_map[10][1]} = (${text}.${last_part_last})${unicode_map[8][1]}";
    // print(explain);
    ...
    finatText = finatText +
        ...
        "\n" +
        "Now, we have to scan the remainder from the bottom. So, the integer part binary number is = $text" +
        "\n\nThe complete result is: \n\n($dublicate)${unicode_map[10][1]} = ($text)${unicode_map[8][1]}";
    return finatText;
  }
}
...
List fractional_part(String fraction) {
  ...
  for (var i = 0; i < 10; i++) {
    ...
    FractionText = FractionText +
        "$add_zero * 8 = $convert_to_string Integer ${convert_to_double.floor()} \n";
  }
